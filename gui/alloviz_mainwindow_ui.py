...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionShow_Calculation_Parameters = QtWidgets.QAction(MainWindow)
        self.actionShow_Calculation_Parameters.setObjectName("actionShow_Calculation_Parameters")
        self.actionViz_Analysis_Results = QtWidgets.QAction(MainWindow)
        self.actionViz_Analysis_Results.setObjectName("actionViz_Analysis_Results")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_hide_fraction.setText(_translate("MainWindow", "0.5"))
        self.label_8.setText(_translate("MainWindow", "Show elements above (fraction of maximum)"))
        ...
        self.actionShow_Calculation_Parameters.setText(_translate("MainWindow", "Show Calculation Parameters..."))
        self.actionViz_Analysis_Results.setText(_translate("MainWindow", "Visualize Analysis Results..."))
        self.actionViz_Analysis_Results.setToolTip(_translate("MainWindow", "Visualize Analysis Results"))
