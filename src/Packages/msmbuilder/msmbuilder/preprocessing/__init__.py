...
from sklearn.impute import SimpleImputer # Changed by frannerin
...
#class Imputer(MultiSequencePreprocessingMixin, preprocessing.Imputer): # Changed by frannerin
#    __doc__ = preprocessing.Imputer.__doc__ # Changed by frannerin
class Imputer(MultiSequencePreprocessingMixin, SimpleImputer): # Changed by frannerin
    __doc__ = SimpleImputer.__doc__ # Changed by frannerin
